...
*/}}
{{- define "bjw-s.common.lib.vaultStaticSecret.getByIdentifier" -}}
  ...
  {{- if (hasKey $enabledVaultStaticSecret $identifier) -}}
    {{- $objectValues := get $enabledVaultStaticSecret $identifier -}}
    {{- $obj := (include "bjw-s.common.lib.valuesToObject" (dict "rootContext" $rootContext "id" $identifier "values" $objectValues "itemCount" (len $enabledVaultStaticSecret))) | fromYaml -}}
